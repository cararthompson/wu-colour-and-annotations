...
subtitle: "Workshops for Ukraine | `r verbaliseR::prettify_date('2023-04-20', uk_or_us = 'UK')`"
from: markdown+emoji
format:
  revealjs: 
    transition: none
    ...
    footer: |
        Slides: [cararthompson.com/talks/wu-colour-and-annotations/](https://www.cararthompson.com/talks/wu-colour-and-annotations/)
filters:
 - code-visibility
 - lightbox
lightbox: auto
...
Data Visualisation Consultant, specialising in helping research teams and data-driven orgs create compelling and memorable visualisations
...
::: {.incremental}
- Provide you with reusable code to implement these tips
...
::: fragment
<center>
"Sound Symbolism" - Wolfgang K\"ohler 1929
</center>
:::
...
- Colour intensity with colour symbolism - consider "dark mode"
...
- Check what they look like together (`monochromeR::view_palette(c("#fab909", "#E93603", "#323A30", "#0C1509"))`
- Check what they look through {colorblindr} (`colorblindr::cvd_grid()`)

**See you in 5 minutes!**  📊 🎨 ☕  

```{r}
countdown::countdown(minutes = 5L, warn_when = 180, style = "border-color: #28A569")
```
...
TODO: Add screenshot of AGG setting
...
- Custom fonts
- Set of colours (for viz elements and text)
...
TODO: At this point, we're on our way to implementing our Dataviz Design System in R, packaging it up for use in future plots!
Show how to make a theme function.


TODO break for them to look at font options + text colours they want to use and try to make that work 
TODO instructions for installing fonts? 
...
- Add a textbox using ggtext::geom_textbox()
- Add in some styling and conditional alignments
- See what happens when you apply it to different data points

TODO: Add reminder of code needed
