---
title: "Using colour and annotations for effective story telling"
subtitle: "Workshops for Ukraine | #rstats #ggplot | `r verbaliseR::prettify_date('2023-04-20', uk_or_us = 'UK')`"
from: markdown+emoji
format:
  revealjs: 
    transition: none
    ...
    footer: |
        Slides: [cararthompson.com/talks/colour-and-annotations/](https://www.cararthompson.com/talks/wu-colour-and-annotations/)
filters:
 - code-visibility
 - lightbox
lightbox: auto
...
![](https://yutannihilation.github.io/gghighlight/articles/gghighlight_files/figure-html/gghighlight-simple-1.png){width=50%}
...
![](images/Fo7VnZ1XwAA0C9Q.jpg){width=66%}
